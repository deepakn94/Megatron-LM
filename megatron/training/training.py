...
from megatron.training.checkpointing import save_checkpoint, save_state_dict
...
def train_step(forward_step_func, data_iterator, model, optimizer, opt_param_scheduler, config, forward_backward_func, iteration=None):
    ...
    while rerun_state_machine.should_run_forward_backward(data_iterator):
        ...
        for model_chunk in model:
            ...
            # If saving main_grads in this iteration, then all-reduce instead of
            # reduce-scatter by setting force_all_reduce field for this iteration.
        ...
        if save_activations_in_this_iteration:
            enable_activation_logging(model)
    ...
    def _save_state_dict(attr_name, label):
        ...
        save_state_dict(state_dict, iteration + 1, label)
